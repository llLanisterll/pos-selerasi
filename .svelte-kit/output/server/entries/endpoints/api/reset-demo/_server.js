...
async function POST({ request, cookies }) {
	try {
		...
		const defaultCategories = [
			{
				id: "1",
				name: "Penjualan Ricebowl (Offline)",
				type: "income",
				bgClass: "bg-brand-50",
			...
			{
				id: "2",
				name: "Pesanan Online (Go/Grab/Shopee)",
				type: "income",
				bgClass: "bg-blue-50",
		...
		const txToInsert = [
			{
				id: "1",
				description: "Ricebowl Ayam Sambal Matah",
				amount: 3e6,
				type: "income",
				category: "Penjualan Ricebowl (Offline)",
				date: "2026-05-28",
				quantity: 120,
				payment_method: "QRIS"
			},
			{
				id: "2",
				description: "Ricebowl Beef Yakiniku",
				amount: 45e5,
				type: "income",
				category: "Pesanan Online (Go/Grab/Shopee)",
				date: "2026-05-27",
				quantity: 180,
				payment_method: "Aplikasi Online"
			},
			{
				id: "3",
				description: "Belanja Beras, Ayam Fillet, & Sayuran di Pasar",
				amount: 15e5,
				type: "expense",
				category: "Bahan Baku",
				date: "2026-05-26",
			...
			{
				id: "4",
				description: "Beli Paper Bowl Sablon Logo Selerasi 1.000 Pcs",
				amount: 12e5,
				type: "expense",
				category: "Packaging",
				date: "2026-05-25",
			...
			{
				id: "5",
				description: "Ricebowl Chicken Teriyaki",
				amount: 2e6,
				type: "income",
				category: "Katering & Event",
				date: "2026-05-24",
				quantity: 80,
				payment_method: "Transfer Bank"
			}
